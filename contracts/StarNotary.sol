...
contract StarNotary is ERC721 {
    ...
    string public constant name = "ShiningStar";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender,"Messager sender need to own a token");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        _transferFrom(fromAddress,_to1,_tokenId);
    }
